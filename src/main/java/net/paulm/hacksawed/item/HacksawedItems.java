...
public class HacksawedItems {
    ...
    public static final Item BOUNCY_BALL = registerItem("bouncy_ball", new BouncyBallItem(new FabricItemSettings().maxCount(8)));
    public static final Item RETURNAL_ORB = registerItem("returnal_orb", new ReturnalOrbItem(new FabricItemSettings().maxCount(8)));
